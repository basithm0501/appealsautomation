...
class Automator:
    ...
    def populate_page(self):
        ...
        eventListColumns = {'BX' : 'program', 'DA':'programSeries', 'EE': 'tripCC', 'EZ': 'tripOther',
                            'FU': 'program', 'GX': 'programSeries', 'IB': 'tripCC', 'IW': 'tripOther', 'JR': 'program',
                            'KU': 'programSeries', 'LY':'tripCC', 'MT':'tripOther'}
